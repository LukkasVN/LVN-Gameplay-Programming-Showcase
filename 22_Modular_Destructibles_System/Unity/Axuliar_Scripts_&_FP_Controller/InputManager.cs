...
public class InputManager : MonoBehaviour
{
    ...
    private InputAction _hitInteract;
    ...
    public bool isHitInteracting { get; private set; }
    ...
    private void Awake()
    {
        ...
        _hitInteract = _playerInput.actions["HitInteract"];
    ...
    private void Update()
    {
        ...
        isHitInteracting = _hitInteract.WasPressedThisFrame();
